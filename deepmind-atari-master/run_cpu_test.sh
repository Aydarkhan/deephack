...
update_freq=4 # 
actrep=4
discount=0.99 # coefficient to limit reward
seed=1 
learn_start=50000
pool_frms_type="\"max\""
pool_frms_size=2
initial_priority="false"
replay_memory=100000 # memory parameter for actor to use history
eps_end=0.1
...
state_dim=7056 # number of dimensions of environment 
ncols=1
